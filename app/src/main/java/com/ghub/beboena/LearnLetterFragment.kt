...
import kotlinx.android.synthetic.main.fragment_learn_letter.*
...
class LearnLetterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        btn.setOnClickListener { view ->
            view.findNavController().navigate(R.id.fragmentTranscriptSentences)
        }

        //this.button.setOnClickListener(Navigation.createNavigateOnClickListener(R.id.fragmentTranscriptSentences, null))
